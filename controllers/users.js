...
export const createCustomer = async (req, res) => {
  var apiUrl =
    "http://wirelessapi.mvnocloudsolutions.com/PrepaidWireless/AddSubscriberOrderWithEBBData";
  const config = {
  ...
  var data = {
    Credential: {
      CLECID: "99",
      UserName: "MAXSIP-PWG",
      TokenPassword: "6525B1DS-B756HU-3955484-928ZP-7AS3A71869KJ",
      PIN: "951865",
    },
    ETCData: {
      ETCFlag: "false",
      LifelineCertificationTypeID: req.body.typeId,
      TribalFlag: "false",
    ...
    EBBData: {
      LifelineCertificationTypeID: req.body.typeId,
      ServiceType: "",
      DeviceReimbursementDate: "07/27/2022",
      DeviceType: "",
      DeviceMake: "",
      ExpectedRateDevice: "",
      AVPProgramException: "false",
      SchoolLunchException: "false",
      SchoolLunchCertificate: "false",
      SchoolName: "",
      ConsumerEmail: "",
      AMSFailureException: "false",
      DupLicateAddressException: "false",
      CertIndicator: "false",
      ExpectedRate: "",
      Latitude: "",
      Longitude: "",
    ...
    WirelessProviderTypeID: "100001",
    CustomerPackageID: "1194",
    Author: req.body.authorEmail,
    RepNotAssisted: "true",
    ValidateZipCodeOnly: "true",
    // "IsChildOrDependent": "${formModel.isChildOrDependent}",
    // "BQPFirstName": formModel.childFirstName,
    // "BQPLastName": formModel.childLastName,
    // "BQPMiddleName": formModel.childMiddleName,
    // "BQPSSN": formModel.childSsn,
    // "BQPTribalId": formModel.chilTribleId,
    // "BQPDOB": formModel.childDOB,
  };
  axios
    .post(apiUrl, data, config)
    .then(function (response) {
